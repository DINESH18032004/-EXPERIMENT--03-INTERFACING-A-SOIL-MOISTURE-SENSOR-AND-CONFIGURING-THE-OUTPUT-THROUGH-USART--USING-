...
#if defined (__ICCARM__) || defined (ARMCC_VERSION)
...
int main(void)
{
  ...
  while (1)
  {
	  printf("SUDHARSAN RAM M\n");
    printf("INTRODUCTION TO IOT\n");
	  HAL_Delay(500);
  }
}
PUTCHAR_PROTOTYPE
...
## Output screen shots of Serial port utility   :
 ...
 ![image](https://github.com/sanjaythiyagarajan/-EXPERIMENT--03-INTERFACE-IOT-BOARD-AND-CONFIGURE-USART-TO-TRANSFER-STRINGS-/assets/119409242/f7cb74bb-ebc3-43e3-8694-7dbe78eefbc2)
